...
public class Journey_Details extends JFrame{  
    ...
    JTable table;
    JLabel ReservationDetails,Pnrno,Ticketid,Scode,Jnydate,Jnytime,Source,Destination,label,label1;
    JButton Show;
	...
	Scode = new JLabel("S_CODE");
	Scode.setFont(new Font("Tahoma", Font.PLAIN, 13));
	Scode.setBounds(297, 270, 103, 20);
	add(Scode);
	...
	String[] items1 =  {"Bangalore","Mumbai","Chennai","Goa","New Delhi","Hyderabad"};
	JComboBox comboBox = new JComboBox(items1);
	comboBox.setBounds(150, 100, 150, 27);
	add(comboBox);
		
		
	String[] items2 =  {"Bangalore","Mumbai","Chennai","Goa","New Delhi","Hyderabad"};
	...
	Show.addActionListener(new ActionListener(){
		...
		try{
                    ...
                    String str = "select pnr_no,ticket_id,s_code,jny_date,jny_time,src,dst from reservation2 where src = '"+src+"' and dst = '"+dst+"';";
