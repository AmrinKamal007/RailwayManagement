...
public class Add_customer extends JFrame{ 
	...
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public Add_customer(){
            ...
            aadhaarno.setFont(new Font("Tahoma", Font.PLAIN, 17));
            aadhaarno.setBounds(60, 80, 150, 27);
            add(aadhaarno);
            ...
            Stationcode.setFont(new Font("Tahoma", Font.PLAIN, 17));
            Stationcode.setBounds(60, 30, 150, 27);
            add(Stationcode);
            ...
            ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("railwaymanagementsystem/icons/customer.jpeg"));
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    try {
                        conn c = new conn();
                        String str = "INSERT INTO passenger values( '"+pnr_no+"', '"+address+"', '"+nationality+"','"+name+"', '"+gender+"', '"+ph_no+"','"+aadhaar_No+"', '"+St_code+"')";
